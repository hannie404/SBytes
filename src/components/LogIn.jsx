...
function RegistrationPage(props) {
   ...
   return <div className={classes.loginCard}>
      ...
      {!response ? <div className="form">
         ...
         <form onSubmit={registrationSubmitHandler}>
            ...
            <div style={{ marginTop: '10px' }}>
               <Button type="submit" fullWidth className='w-100'>Create account</Button>
               <Divider />
            </div>
      ...
      <Button className='w-100' fullWidth onClick={backToLogin} color="green" iconLeft={<FaArrowLeft />}>Back to log in</Button>
